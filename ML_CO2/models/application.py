...
pickle_in = open('Streamlit_app/model_pickle.pkl', 'rb')
...
def main():
    ...
    if st.button("Predict"):
        ...
        #db_update(Engine_Size, Cylinders,Fuel_Consumption_City,Fuel_Consumption_Hwy,Fuel_Consumption_Comb,Fuel_Consumption_Comb_mpg,result)
